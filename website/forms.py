...
class RegisterUserForm(UserCreationForm):
    email = forms.EmailField(label="",widget=forms.TextInput(attrs={'class':'form-control','placeholder':'E-mail Adress'}))
...
class AddRecordForm(forms.ModelForm):
    ...
    email = forms.CharField(label='', required=True, widget=forms.widgets.TextInput(attrs={"placeholder":"E-mail", "class":"form-control"}))
    ...
    country = forms.CharField(label='', required=True, widget=forms.widgets.TextInput(attrs={"placeholder":"Country", "class":"form-control"}))
